<template>
  <section v-if="!cart.length">
    ...
    <nuxt-link exact to="/">
      <button class="primary">Fill it Up</button></nuxt-link
    >
  </section>
</template>
